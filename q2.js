...
console.log("Random number is: ".concat(ranNum));
var isCorrect = false;
var storeGuesses = [3, 2, 4, 5, 6, 1];
var i = 0;
while (i < storeGuesses.length && !isCorrect) {
    if (storeGuesses[i] === ranNum) {
        console.log("".concat(storeGuesses[i], ",your guessed numberis high,try again."));
    }
    else {
        console.log("".concat(storeGuesses[i], " is too low, try again."));
    }
    i++;
}
